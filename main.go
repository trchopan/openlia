...
//
//go:embed all:docker all:profile all:workspace-template all:locho all:release all:packages/browser-tools/dist all:packages/workspace-ui/dist all:packages/openlia-job/dist
